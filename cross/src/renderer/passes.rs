...
pub fn build_frame_uniforms(
    ...
    let light_dir = Vec3::new(-0.65, -0.15, 0.75).normalize();
    ...
    FrameUniforms {
        ...
        ambient_color: [0.0, 0.0, 0.0, highlight_hole as f32],
        camera_pos: [eye.x, eye.y, eye.z, 1.0],
        ortho_half_size_shadow_bias: [half_w, half_h, 0.0012, 0.0],
        shadow_inv_size_unused: [inv_shadow, inv_shadow, 0.0, table_mode as f32],
